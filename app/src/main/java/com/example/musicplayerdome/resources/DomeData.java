...
public class DomeData {
    ...
    public static List<Audio> getRecommendMusic(){
        ...
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005061541/31417a39b27979c46ccdf57353459ac5/G114/M01/1F/10/sg0DAFnWF0mAWSkzADPphbA0r2s996.mp3")
                .setauthor("周杰伦")
        ...
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005061541/d987f6be7c5c664a16fb4df16c91de93/G196/M09/1D/10/pJQEAF5Q7_-AK5BUAC5sFI5LTMc356.mp3")
                .setauthor("Maroon 5")
        ...
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005061541/588f68abfff731cd9c9efb23e5274f10/G179/M08/1D/0F/8w0DAF3zZCaATgO6AEENs8ADOpM292.mp3")
                .setauthor("周杰伦")
