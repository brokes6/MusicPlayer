...
public class DomeData {
    ...
    public static List<Audio> getAudioMusic(){
        ...
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005031010/2cd70f76510f45a63ebf7b52f145f27d/G078/M02/0D/18/jg0DAFhwj_iAMlxkADJKTpoJJ6g903.mp3")
                .setauthor("林宥嘉")
                .setid(1)
        );
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005031004/efb63fd655b947e28fe4a6c891c5d46f/G109/M05/14/05/DYcBAFmChraAWB69ADycuwiDeCs643.mp3")
                .setauthor("初音未来")
                .setid(2)
        );
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005031010/83b6d7865c4da4d417d4054f6962c18f/G191/M09/05/0B/X4cBAF4Sj0iAcecWADWuVe9xtII389.mp3")
                .setauthor("Sou")
                .setid(3)
        );
        list.add(new Audio()
                ...
                .setUrl("https://sharefs.yun.kugou.com/202005031010/ba186a76882a44d9a549c6011c32b1ea/G169/M03/10/0B/iZQEAF0ucCSAX6kFADeqFkOQg-M882.mp3")
                .setauthor("MIYAVI")
                .setid(4)
        );
        list.add(new Audio()
